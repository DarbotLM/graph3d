...
**En ferdighet for AI-kodeassistenter.** Skriv `/graph3d` i Claude Code, Codex, OpenCode, Cursor, Gemini CLI, GitHub Copilot CLI, VS Code Copilot Chat, Aider, OpenClaw, Factory Droid, Trae, Hermes, Kiro eller Google Antigravity — den leser filene dine, bygger en kunnskapsgraf og gir deg tilbake strukturen du ikke visste eksisterte. Forstå en kodebase raskere. Finn «hvorfor» bak arkitektoniske beslutninger.

Fullt multimodal. Legg til kode, PDF-er, markdown, skjermbilder, diagrammer, whiteboardbilder, bilder på andre språk eller video- og lydfiler — graph3d ekstraherer begreper og relasjoner fra alt og kobler dem i én graf. Videoer transkriberes lokalt med Whisper. Støtter 25 programmeringsspråk via tree-sitter AST.

> Andrej Karpathy opprettholder en `/raw`-mappe der han legger artikler, tweets, skjermbilder og notater. graph3d er svaret på det problemet — **71,5x** færre tokens per spørring sammenlignet med å lese råfiler, vedvarende mellom sesjoner.
...
> **Offisiell pakke:** PyPI-pakken heter `graph3d`. Det eneste offisielle depotet er [DarbotLM/graph3d](https://github.com/DarbotLM/graph3d).
...
/graph3d .
/graph3d ./raw --update
/graph3d query "hva kobler Attention til optimizeren?"
...
[**Penpax**](https://safishamsi.github.io/penpax.ai) er enterprise-laget oppå graph3d. **Gratis prøveperiode kommer snart.** [Bli med på ventelisten →](https://safishamsi.github.io/penpax.ai)
