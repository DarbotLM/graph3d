...
graph3d is a Claude Code skill backed by a Python library. The skill orchestrates the library; the library can be used standalone.
...
All external input passes through `graph3d/security.py` before use:
