# Graph3d Evaluation - httpx Corpus (2026-04-03)
...
**Pipeline:** graph3d AST extractor + graph_builder + Leiden clusterer + analyzer + reporter
**Method:** Full deterministic code tracing of every graph3d source module against
...
```markdown
# Graph Report - /home/safi/graph3d_test/httpx  (2026-04-03)
...
The graph3d AST extractor is deterministic, fast, and accurate for what it extracts.
