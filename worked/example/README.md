...
Run graph3d on it and you get a knowledge graph showing how the modules connect, which functions call which, and how the architecture notes relate to the code.
...
The graph lives in `graph3d-out/` and persists across sessions.
