# Graph3d Evaluation - Mixed Corpus (2026-04-04)
...
**Finding:** Communities are semantically correct - the three graph3d modules map cleanly
...
detect() on eval root with graph3d-out/memory/ present:
...
**What graph3d extracts (Claude vision reads directly, no reshaper/bidi needed):**
...
identically to English. The image node in graph3d is just a path - the vision subagent does
the rest.
