...
Example output:
    === Graph3d AST Extraction Benchmark ===
    Files:        1,247
...
from graph3d.extract import extract, collect_files
from graph3d.cache import clear_cache
...
def main() -> None:
    ...
    print("=== Graph3d AST Extraction Benchmark ===\n")
