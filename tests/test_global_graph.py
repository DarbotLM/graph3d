"""Tests for the global graph infrastructure (graph3d/global_graph.py),
prefix/prune helpers in graph3d/build.py, and the cross-repo guard in
graph3d/dedup.py."""
...
def test_prefix_graph_preserves_label():
    from graph3d.build import prefix_graph_for_global
...
def test_global_add_creates_global_graph(tmp_path):
    ...
    with patch("graph3d.global_graph._GLOBAL_DIR", global_dir), \
         patch("graph3d.global_graph._GLOBAL_GRAPH", global_dir / "global-graph.json"), \
         patch("graph3d.global_graph._GLOBAL_MANIFEST", global_dir / "global-manifest.json"):
...
def test_global_add_two_repos_no_collision(tmp_path):
    ...
    with patch("graph3d.global_graph._GLOBAL_DIR", global_dir), \
         patch("graph3d.global_graph._GLOBAL_GRAPH", global_graph_path), \
         patch("graph3d.global_graph._GLOBAL_MANIFEST", global_manifest_path):
        from graph3d.global_graph import global_add, _load_global_graph
        global_add(g1, "repoA")
        global_add(g2, "repoB")
...
def test_global_remove(tmp_path):
    ...
    with patch("graph3d.global_graph._GLOBAL_DIR", global_dir), \
         patch("graph3d.global_graph._GLOBAL_GRAPH", global_dir / "global-graph.json"), \
         patch("graph3d.global_graph._GLOBAL_MANIFEST", global_dir / "global-manifest.json"):
        from graph3d.global_graph import global_add, global_remove
        global_add(src_graph, "repoA")
    ...
    with patch("graph3d.global_graph._GLOBAL_DIR", global_dir2), \
         patch("graph3d.global_graph._GLOBAL_GRAPH", global_dir2 / "global-graph.json"), \
         patch("graph3d.global_graph._GLOBAL_MANIFEST", global_dir2 / "global-manifest.json"):
        from graph3d.global_graph import global_list
        repos = global_list()
...
def test_global_remove_unknown_tag_raises(tmp_path):
    ...
    with patch("graph3d.global_graph._GLOBAL_DIR", global_dir), \
         patch("graph3d.global_graph._GLOBAL_GRAPH", global_dir / "global-graph.json"), \
         patch("graph3d.global_graph._GLOBAL_MANIFEST", global_dir / "global-manifest.json"):
        from graph3d.global_graph import global_remove
