"""Tests for graph3d.transcribe — video/audio transcription support."""
...
def test_build_whisper_prompt_env_override(monkeypatch):
    """GRAPH3D_WHISPER_PROMPT env var short-circuits LLM call."""
...
def test_build_whisper_prompt_returns_topic_string():
    ...
    with patch.dict(os.environ, {}, clear=False):
        os.environ.pop("GRAPH3D_WHISPER_PROMPT", None)
...
def test_transcribe_force_reruns(tmp_path):
    ...
    with patch("graph3d.transcribe._get_whisper", return_value=lambda *a, **kw: fake_model):
