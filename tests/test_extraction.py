...
def test_language_extractors_structural():
    case_table = [
        ...
        ("go", extract_go, "sample.go", ["Server", "Start", "Stop", "NewServer"], {"imports", "calls", "embeds", "references"}),
        ...
        ("rust", extract_rust, "sample.rs", ["Graph", "add_node", "add_edge", "build_graph"], {"imports", "calls", "implements", "inherits", "references"}),
